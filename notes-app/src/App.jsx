      ...
      <form onSubmit={ (e) =>{
       ...
       className='flex gap-4 lg:w-1/2 p-10 flex-col items-start '>
        <h1 className='text-3xl font-bold'>Add Notes</h1>
          ...
          <textarea 
          type="text"
            className='px-5 w-full font-medium  h-32 flex items-start flex-row py-2 border-2 rounded outline-none'
          ...
          <button className='bg-white font-medium  w-full text-black px-5 py-2 rounded outline-none'>Add Notes</button>
      </form>
